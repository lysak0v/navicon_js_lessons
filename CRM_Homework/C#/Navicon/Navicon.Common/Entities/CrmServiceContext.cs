...
namespace Navicon.Common.Entities
{
	...
	public partial class CrmServiceContext : Microsoft.Xrm.Sdk.Client.OrganizationServiceContext
	{
		...
		/// <summary>
		/// Gets a binding to the set of all <see cref="Navicon.Common.Entities.ActivityParty"/> entities.
		/// </summary>
		public System.Linq.IQueryable<Navicon.Common.Entities.ActivityParty> ActivityPartySet
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.CreateQuery<Navicon.Common.Entities.ActivityParty>();
			}
		}
		...
		/// <summary>
		/// Gets a binding to the set of all <see cref="Navicon.Common.Entities.Email"/> entities.
		/// </summary>
		public System.Linq.IQueryable<Navicon.Common.Entities.Email> EmailSet
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.CreateQuery<Navicon.Common.Entities.Email>();
			}
		}
		
		/// <summary>
		/// Gets a binding to the set of all <see cref="Navicon.Common.Entities.lys_agreement"/> entities.
		/// </summary>
		public System.Linq.IQueryable<Navicon.Common.Entities.lys_agreement> lys_agreementSet
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.CreateQuery<Navicon.Common.Entities.lys_agreement>();
			}
		}
		
		/// <summary>
		/// Gets a binding to the set of all <see cref="Navicon.Common.Entities.lys_communication"/> entities.
		/// </summary>
		public System.Linq.IQueryable<Navicon.Common.Entities.lys_communication> lys_communicationSet
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.CreateQuery<Navicon.Common.Entities.lys_communication>();
			}
		}
		
		/// <summary>
		/// Gets a binding to the set of all <see cref="Navicon.Common.Entities.lys_invoice"/> entities.
		/// </summary>
		public System.Linq.IQueryable<Navicon.Common.Entities.lys_invoice> lys_invoiceSet
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.CreateQuery<Navicon.Common.Entities.lys_invoice>();
			}
		}
		
		/// <summary>
		/// Gets a binding to the set of all <see cref="Navicon.Common.Entities.SystemUser"/> entities.
		/// </summary>
		public System.Linq.IQueryable<Navicon.Common.Entities.SystemUser> SystemUserSet
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.CreateQuery<Navicon.Common.Entities.SystemUser>();
			}
		}
	}
