...
namespace Navicon.ConsoleApp01.Entities
{
	...
	public partial class Contact : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public System.Nullable<Navicon.ConsoleApp01.Entities.ContactState> StateCode
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				...
				if ((optionSet != null))
				{
					return ((Navicon.ConsoleApp01.Entities.ContactState)(System.Enum.ToObject(typeof(Navicon.ConsoleApp01.Entities.ContactState), optionSet.Value)));
				}
				else
				{
					return null;
